            ...
            case T_LT: {
                ...
                if(resolved == null) {
                    ...
                    if(!parser.ignoreBracketErrors) {
                        parser.getEnvironment().getErrorLogger().error(start.getStart(), next.getEnd(), "Could not resolve " + builder.toString());
                    } else {
                        parser.getEnvironment().getErrorLogger().info(start.getStart(), next.getEnd(), "Could not resolve " + builder.toString());
                    }
